...
namespace JYW.ArrowBattle.UIs
{
    public class ResultPanel : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            EventManager.Instance.GameResultUIEvent -= StartUI;
            EventManager.Instance.GameResultUIEvent += StartUI;
        }
        ...
        Sprite GetResultImg(ResultStateEnum resultStateEnum)
        {
            switch (resultStateEnum)
            {
                case ResultStateEnum.Victory:
                    return victorySprite;

                case ResultStateEnum.Defeat:
                    return defeatSprite;
        ...
        private void StartUI(ResultStateEnum resultStateEnum)
        {
            ...
            bgImg.sprite = GetResultImg(resultStateEnum);
            bgImg.enabled = true;
            var c = bgImg.color;
